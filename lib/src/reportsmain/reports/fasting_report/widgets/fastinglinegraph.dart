...
class FastingLineChart extends StatefulWidget {
  const FastingLineChart({super.key});

  @override
  State<FastingLineChart> createState() => _FastingLineChartState();
}

class _FastingLineChartState extends State<FastingLineChart> {
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: Text(AppLocalizations.of(context)!.homeFasthours,
