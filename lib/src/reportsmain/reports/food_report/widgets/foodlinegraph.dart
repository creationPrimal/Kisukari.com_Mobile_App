...
class FoodLineChart extends StatefulWidget {
  const FoodLineChart({super.key});

  @override
  State<FoodLineChart> createState() => _FoodLineChartState();
}

class _FoodLineChartState extends State<FoodLineChart> {
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: Text(AppLocalizations.of(context)!.reportexcercisecalorie,
