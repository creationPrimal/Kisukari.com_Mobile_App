...
class ExcerciseLineChart extends StatefulWidget {
  const ExcerciseLineChart({super.key});

  @override
  State<ExcerciseLineChart> createState() => _ExcerciseLineChartState();
}

class _ExcerciseLineChartState extends State<ExcerciseLineChart> {
        ...
        Row(
          children: [
            ...
            Padding(
              ...
              child: Text(AppLocalizations.of(context)!.reportexcerciseburntcalories,
