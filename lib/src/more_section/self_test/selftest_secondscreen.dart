...
class SelfTestSecondScreen extends StatefulWidget {
  const SelfTestSecondScreen({super.key});

  @override
  State<SelfTestSecondScreen> createState() => _SelfTestSecondScreenState();
}

class _SelfTestSecondScreenState extends State<SelfTestSecondScreen> {
                          ...
                          Center(
                            child: Row(
                              ...
                              children: [
                                ...
                                // next
                                _genderbtns[0].isActive || _genderbtns[1].isActive ? // check if any button is selected
                                GestureDetector(
                                  onTap: () {
                                    Navigator.pushNamed(context, selftestthirdscreen);
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: Kcolors.mainRed,
