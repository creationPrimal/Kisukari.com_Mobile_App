...
class SelfTestSixthScreen extends StatefulWidget {
  const SelfTestSixthScreen({super.key});

  @override
  State<SelfTestSixthScreen> createState() => _SelfTestSixthScreenState();
}

class _SelfTestSixthScreenState extends State<SelfTestSixthScreen> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text(
                                    AppLocalizations.of(context)!.selftestScreen5affirmtitle,
                             ...
                             Column(
                              children: [
                                  ...
                                  padding: const EdgeInsets.only(bottom: 15.0),
                                    child: Text(
                                      AppLocalizations.of(context)!.selftestScreen5affirmbody,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.roboto(
                                        color: Kcolors.mainWhite,
                                        fontSize: 16,
                          ...
                          Center(
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.pushNamed(context, selftestseventhscreen);
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: Kcolors.mainRed,
