...
class SelfTestFifthScreen extends StatefulWidget {
  const SelfTestFifthScreen({super.key});

  @override
  State<SelfTestFifthScreen> createState() => _SelfTestFifthScreenState();
}

class _SelfTestFifthScreenState extends State<SelfTestFifthScreen> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text(
                                    AppLocalizations.of(context)!.selftestScreen4affirmtitle,
                             ...
                             Column(
                              children: [
                                  ...
                                  padding: const EdgeInsets.only(bottom: 15.0),
                                    child: Text(
                                      AppLocalizations.of(context)!.selftestScreen4affirmbody,
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.roboto(
                                        color: Kcolors.mainWhite,
                                        fontSize: 16,
                          ...
                          Center(
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.pushNamed(context, selftestsixthscreen);
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: Kcolors.mainRed,
