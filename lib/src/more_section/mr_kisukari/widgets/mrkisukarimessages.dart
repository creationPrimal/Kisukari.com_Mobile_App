...
class MrKisukariChats extends StatefulWidget {
  const MrKisukariChats({super.key});

  @override
  State<MrKisukariChats> createState() => _MrKisukariChatsState();
}

class _MrKisukariChatsState extends State<MrKisukariChats> {
  @override
