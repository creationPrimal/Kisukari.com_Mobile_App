...
class MentalThirdPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const MentalThirdPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<MentalThirdPage> createState() => _MentalThirdPageState();
}

class _MentalThirdPageState extends State<MentalThirdPage> {
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.mentalqstn2,
