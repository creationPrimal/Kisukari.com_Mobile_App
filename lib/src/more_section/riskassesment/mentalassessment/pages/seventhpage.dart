...
class MentalSeventhPage extends StatefulWidget {
  const MentalSeventhPage({super.key});

  @override
  State<MentalSeventhPage> createState() => _MentalSeventhPageState();
}

class _MentalSeventhPageState extends State<MentalSeventhPage> {
                    ...
                    child:
                      Column(
                        children: [
                          ...
                          // result info
                          Text(
                            AppLocalizations.of(context)!.mentalresultscomment,
                            textAlign: TextAlign.center,
                            style: GoogleFonts.roboto(
                              color: Kcolors.mainWhite,
                              fontSize: 20,
                          ...
                          const SizedBox(height:20), // space
                          Text(
                            AppLocalizations.of(context)!.mentalresultsbody,
                            textAlign: TextAlign.center,
                            style: GoogleFonts.roboto(
                              color: Kcolors.mainWhite,
                              fontSize: 20,
