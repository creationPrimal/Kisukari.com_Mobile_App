...
class MentalFifthPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const MentalFifthPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<MentalFifthPage> createState() => _MentalFifthPageState();
}

class _MentalFifthPageState extends State<MentalFifthPage> {
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.mentalqstn4,
