...
class MentalFourthPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const MentalFourthPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<MentalFourthPage> createState() => _MentalFourthPageState();
}

class _MentalFourthPageState extends State<MentalFourthPage> {
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.mentalqstn3,
