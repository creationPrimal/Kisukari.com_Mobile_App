...
class MentalSecondPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const MentalSecondPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<MentalSecondPage> createState() => _MentalSecondPageState();
}

class _MentalSecondPageState extends State<MentalSecondPage> {
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context)!.mentalqstn1,
