...
class SugarFifthPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const SugarFifthPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<SugarFifthPage> createState() => _SugarFifthPageState();
}

class _SugarFifthPageState extends State<SugarFifthPage> {
