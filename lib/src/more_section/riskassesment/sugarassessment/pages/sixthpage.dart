...
class SugarSixthPage extends StatefulWidget {
  final VoidCallback nextPage;
  final VoidCallback previousPage;
  const SugarSixthPage({super.key, required this.nextPage, required this.previousPage});

  @override
  State<SugarSixthPage> createState() => _SugarSixthPageState();
}

class _SugarSixthPageState extends State<SugarSixthPage> {
