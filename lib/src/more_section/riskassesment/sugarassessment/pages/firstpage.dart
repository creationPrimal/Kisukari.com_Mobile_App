...
class SugarFirstPage extends StatefulWidget {
  final VoidCallback callback;
  const SugarFirstPage({super.key, required this.callback});

  @override
  State<SugarFirstPage> createState() => _SugarFirstPageState();
}

class _SugarFirstPageState extends State<SugarFirstPage> {
  @override
